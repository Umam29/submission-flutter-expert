...
void main() {
  ...
  group('get series recommendations', () {
    final tSeriesList = SeriesResponse.fromJson(
            json.decode(readJson('dummy_data/series_recommendation.json')))
        .seriesList;
    final tId = 1;
    ...
    test('should return list of Series Model when the response code is 200',
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/series_recommendation.json'), 200));
      // act
  ...
  group('search series', () {
    final tSearchResult = SeriesResponse.fromJson(
            json.decode(readJson('dummy_data/search_avatar_series.json')))
        .seriesList;
    final tQuery = 'avatar';
    ...
    test('should return list of series when response code is 200', () async {
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/search_avatar_series.json'), 200));
      // act
